...
- **Firm name, phone, email, address** appear in the header, slide-in menu and footer of *all five* pages — search-and-replace across files (e.g. replace `+92 21 0000 0000` and `info@khanassociates.pk` everywhere).
...
### Custom domain
Both Netlify and GitHub Pages let you attach a custom domain (e.g. `khanassociates.pk`) for free — add the domain in their settings and point your DNS at them.
